        ...
        @if($pension_count >0 )
          ...
          @if($petrol_count)
            ...
            @if($loans_counter>0)
                <center>
                    <h3>
                          LOAN ACCOUNTS BALANCE:   {{asMoney($loan_balance)}}
                    </h3>
                  </center>
                  <hr>
               <table class="table table-bordered">
                ...
                @foreach($loans as $loan)
                              <?php
                                  ...
                                  $x=1;
                                  $start_balance=Loantransaction::getLoanBalance($loan);
                               ?>
                               <tr >
                                 <td colspan="6" style="border-bottom:2px dotted #eee;text-align:center;">
                                     <strong>
                                       {{$loan->account_number}}  Loan Balance: {{asMoney($start_balance)}}
                                      </strong>
                                  </td>
                               </tr>
                             ...
                             <tr>
                               ...
                               <?php
                                ...
                                ?>
                               <td>{{asMoney($start_balance-$total_repayment)}}</td>
                               <?php
                                        $start_balance -=$total_repayment;
                                        $x++;
                              ?>
                             </tr>
                             @endforeach
